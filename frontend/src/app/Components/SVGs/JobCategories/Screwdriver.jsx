...
function Screwdriver({width}) {
    return (
        <svg className="global-svgs" style={{width: width, height: width}} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
...
export default memo(Screwdriver);