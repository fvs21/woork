...
const Messages = ({width, color}: SVGProps) => {
    return (
        <svg style={{color: color || "black"}} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={width} height={width} fill="currentColor" viewBox="0 0 24 24">
